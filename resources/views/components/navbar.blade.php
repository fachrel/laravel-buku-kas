      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="/dashboard" class="flex ml-2 md:mr-24">
            {{-- <img src="https://instagram.fsrg6-1.fna.fbcdn.net/v/t51.2885-15/361188252_973234783918505_8115038131485817169_n.jpg?stp=dst-jpg_e35&_nc_ht=instagram.fsrg6-1.fna.fbcdn.net&_nc_cat=105&_nc_ohc=j3zy61ZBAxAAX9DVNyt&edm=ACWDqb8BAAAA&ccb=7-5&ig_cache_key=MzE0OTM2NjM2NzYxMzcwNTIyOQ%3D%3D.2-ccb7-5&oh=00_AfDieT2PDCjRlkq1vCR8247UoSZCENdpvZfAeL4qf4y2Zg&oe=64C6FB5A&_nc_sid=ee9879" class="h-8 mr-3" alt="FlowBite Logo"> --}}
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Kas-buku</span>
          </a>
        ...
        <div class="flex items-center">
            ...
            <button type="button" data-dropdown-toggle="notification-dropdown" class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700" fdprocessedid="jwk3qm">
            ...
            {{-- <button type="button" data-dropdown-toggle="apps-dropdown" class="hidden p-2 text-gray-500 rounded-lg sm:flex hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700" fdprocessedid="jx06nh">
              <span class="sr-only">View notifications</span>
            ...
            <button id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5" fdprocessedid="wtaoc">
              <svg id="theme-toggle-dark-icon" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
            ...
            <div class="flex items-center ml-3">
              <div>
                <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2" fdprocessedid="132a2l">
                  <span class="sr-only">Open user menu</span>
                  <img class="w-8 h-8 rounded-full" src="https://i.postimg.cc/mrpdfktw/michie.jpg" alt="user photo">
                </button>
              </div>
